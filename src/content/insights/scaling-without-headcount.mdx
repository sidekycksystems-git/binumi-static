...
<figure class="video-figure">
  <VideoFrame
    class="reveal"
    tag="Said once, used everywhere"
    duration="1:12"
    label="Scaling expertise video"
  />
  <figcaption>The answer an expert gives over and over, captured once and turned into video the whole organization can reach for.</figcaption>
</figure>
