...
<figure class="video-figure">
  <VideoFrame
    class="reveal"
    tag="One brand, twelve markets"
    duration="1:06"
    label="Brand governance video"
  />
  <figcaption>The same brand standard, expressed in twelve languages across twelve markets, without a central team checking every cut.</figcaption>
</figure>
