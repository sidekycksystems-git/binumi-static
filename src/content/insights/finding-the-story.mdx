...
<figure class="video-figure">
  <VideoFrame
    class="reveal"
    tag="The cut that matters"
    duration="1:04"
    label="Finding the story video"
  />
  <figcaption>A seven page Heathrow proposal, reduced to the ninety seconds a decision-maker actually needed before a key meeting.</figcaption>
</figure>
