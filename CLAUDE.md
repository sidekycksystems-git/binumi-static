# CLAUDE.md, working in the Binumi repo

This file orients Claude Code (and any contributor) on how this repo works and how
...
```
(There is a launch config `binumi-astro` in `.claude/launch.json` for the same thing.)
